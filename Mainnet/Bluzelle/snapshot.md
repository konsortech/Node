...
SNAP_NAME=$(curl -s https://mainnet-bluzelle.konsortech.xyz/bluzelle/ | egrep -o ">bluzelle-snapshot.*\.tar.lz4" | tr -d ">")
curl https://mainnet-bluzelle.konsortech.xyz/bluzelle/${SNAP_NAME} | lz4 -dc - | tar -xf - -C $HOME/.curium
