...
SNAP_NAME=$(curl -s https://snapshot3.konsortech.xyz/irisnet/ | egrep -o ">iris-snapshot.*\.tar.lz4" | tr -d ">")
curl https://snapshot3.konsortech.xyz/irisnet/${SNAP_NAME} | lz4 -dc - | tar -xf - -C $HOME/.iris
