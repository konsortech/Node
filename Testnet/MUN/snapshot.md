...
SNAP_NAME=$(curl -s https://snapshot3.konsortech.xyz/mun-testnet/ | egrep -o ">mun-snapshot.*\.tar.lz4" | tr -d ">")
curl https://snapshot3.konsortech.xyz/mun-testnet/${SNAP_NAME} | lz4 -dc - | tar -xf - -C $HOME/.mun
