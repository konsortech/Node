...
SNAP_NAME=$(curl -s https://snap2.konsortech.xyz/atomone/ | egrep -o ">atomone-snapshot.*\.tar.lz4" | tr -d ">")
curl https://snap2.konsortech.xyz/atomone/${SNAP_NAME} | lz4 -dc - | tar -xf - -C $HOME/.atomone
